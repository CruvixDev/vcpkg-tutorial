...
#define csLIB_VERSION_PROJECT_NAME "vcpkg_tutorial"

#define cu8LIB_VERSION_MAJOR (uint8_t)0
#define cu8LIB_VERSION_MINOR (uint8_t)1
#define cu8LIB_VERSION_PATCH (uint8_t)0

#define csLIB_VERSION_GIT_HASH "8ea3b8f"
